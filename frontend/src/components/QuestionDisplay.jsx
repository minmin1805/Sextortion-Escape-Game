...
function QuestionDisplay({ message, question, playerName }) {
  return (
    <div className="bg-[#ddecff] w-[55%] rounded-2xl flex flex-col justify-center items-center">
      <div className="mt-4 mb-4">
        <p className="text-center font-bold text-xl">
          Hi {playerName ?? "there"}, you just received a message!
        </p>
      </div>
      ...
      <div className="flex mt-8 items-center justify-center gap-4">
        <img src={thiefImage} className="h-17" alt="threat" />
        <div className="w-[50%]">
      ...
      {question && (
        <div className="mt-4">
          <p className="text-center font-bold text-xl text-[#2e0f53]">{question}</p>
        </div>
      )}
