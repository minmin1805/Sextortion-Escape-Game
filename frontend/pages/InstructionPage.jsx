  ...
  return (
    <div className="min-h-screen w-full relative overflow-x-hidden">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(180deg, #1a0a2e 0%, #2d1b4e 35%, #1a0a2e 100%)",
        }}
      />
      <div
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-10 py-12 pb-20">
        ...
        <header className="text-center mb-10">
          <div
            className="inline-flex items-center justify-center w-20 h-20 rounded-2xl border-2 border-[#8B5CF6]/50 bg-[#8B5CF6]/20 mb-4"
            aria-hidden
          >
            {/* Replace with your SE logo image: <img src={logo} alt="" className="w-14 h-14" /> */}
            <span className="text-2xl font-bold text-[#8B5CF6]">SE</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-3 tracking-tight">
            Before You Play
          </h1>
          <p className="text-white text-2xl">
            Learn how to recognize sextortion and make safer choices under pressure.
          </p>
        </header>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[#374151] leading-relaxed text-2xl">
                Sextortion is when someone threatens to share your private images unless you pay or
                send more photos. It is a crime. And if this happens, it is{" "}
                <strong>not your fault</strong>.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <ul className="list-disc list-inside text-[#374151] space-y-1 text-2xl">
                <li>Someone pretends to be your age on social media, dating, or gaming apps</li>
                <li>A &quot;romantic&quot; or friendly chat turning into threats</li>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          <section className={cardClass} style={cardStyle}>
            <div className="flex items-start gap-3">
              <div
                className="shrink-0 w-12 h-12 rounded-xl bg-amber-500/20 flex items-center justify-center"
                aria-hidden
              >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[#374151] text-2xl leading-relaxed">
                  ...
                  <strong>Paying or sending more images usually makes it worse.</strong> The only
                  thing that actually helps is <strong>getting support and reporting it</strong>.
                </p>
              </div>
            </div>
          </section>
          <section className={cardClass} style={cardStyle}>
            <div className="flex items-start gap-3">
              <div
                className="shrink-0 w-12 h-12 rounded-xl bg-emerald-500/20 flex items-center justify-center"
                aria-hidden
              >
                {/* Icon placeholder - e.g. shield with checkmark */}
              ...
              <div className="flex-1 min-w-0">
                ...
                <ul className="text-[#374151] text-2xl space-y-2">
                  <li className="flex items-center gap-2">
                    <span className="text-emerald-500 shrink-0">✓</span> Do NOT pay
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-emerald-500 shrink-0">✓</span> Do NOT send more
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-emerald-500 shrink-0">✓</span> Tell a trusted adult
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-emerald-500 shrink-0">✓</span> Block and screenshot
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-emerald-500 shrink-0">✓</span> Report at: TakeitDown.org
                    and NCMEC CyberTipline.org
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          <section className={cardClass} style={cardStyle}>
            <div className="flex items-start gap-3">
              <div
                className="shrink-0 w-12 h-12 rounded-xl bg-amber-400/20 flex items-center justify-center"
                aria-hidden
              >
                {/* Icon placeholder - e.g. lightbulb */}
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[#374151] text-2xl leading-relaxed">
                  You&apos;ll practice realistic sextortion scenarios under time pressure.
                  You&apos;ll make choices in <strong>30 seconds</strong> — just like{" "}
                  <strong>real life</strong> — and learn safer responses through instant feedback.
                </p>
              </div>
            </div>
          </section>
          <section className={cardClass} style={cardStyle}>
            <div className="flex items-start gap-3">
              <div
                className="shrink-0 w-12 h-12 rounded-xl bg-[#8B5CF6]/20 flex items-center justify-center"
                aria-hidden
              >
                {/* Icon placeholder - e.g. play button / game */}
        ...
        <div className="mt-14 pt-8 border-t-2 border-dashed border-white/30 text-center">
          <p className="text-white text-lg mb-6">Ready to test your instincts?</p>
          <button
